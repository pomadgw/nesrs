...
pub const OPCODE_TABLE: [(AddressMode, Opcode, u32); 256] = [
    ...
    /* 1c */ (AddressMode::Imp, Opcode::Nop, 4),
    ...
    /* 3c */ (AddressMode::Imp, Opcode::Nop, 4),
    ...
    /* 5c */ (AddressMode::Imp, Opcode::Nop, 4),
    ...
    /* 7c */ (AddressMode::Imp, Opcode::Nop, 4),
    ...
    /* dc */ (AddressMode::Imp, Opcode::Nop, 4),
    ...
    /* fc */ (AddressMode::Imp, Opcode::Nop, 4),
